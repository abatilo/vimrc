...
==== SCOPE: epic $NEXT_EPIC ONLY ====

PROCESS:
1. Run 'bd show $NEXT_EPIC' to see issues in THIS epic
...
4. After last issue closed, run 'bd show $NEXT_EPIC' to verify all closed
5. Return: "SCOPE_COMPLETE: $NEXT_EPIC" then STOP
...
Task(
  ...
  prompt=\"==== SCOPE: epic $NEXT_EPIC ONLY ====\\n\\nPROCESS:\\n1. Run 'bd show $NEXT_EPIC' to see issues in THIS epic\\n2. Complete each issue: 'bd update <id> --status=in_progress', implement, test, 'bd close <id> --reason=\\\"...\\\"'\\n3. Use /commit for atomic commits. Create bd issues for discovered bugs.\\n4. After last issue closed, run 'bd show $NEXT_EPIC' to verify all closed\\n5. Return: \\\"SCOPE_COMPLETE: $NEXT_EPIC\\\" then STOP\\n\\nDO NOT: check other epics, continue after scope complete, start new work\"
)"
...
EOF
      ...
      jq -n \
        --arg prompt "==== SCOPE: epic $NEXT_EPIC ONLY ====
