...
```bash
cd ~/.cache/codex/repos/<owner>/<repo>
...
```bash
# Remove and re-clone
rm -rf ~/.cache/codex/repos/<owner>/<repo>
...
```bash
find ~/.cache/codex/repos -maxdepth 2 -mindepth 2 -type d 2>/dev/null
```

### Check Cache Size

```bash
du -sh ~/.cache/codex/repos/
du -sh ~/.cache/codex/repos/*/* 2>/dev/null | sort -h
```
